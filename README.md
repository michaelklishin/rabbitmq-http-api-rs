...
```toml
rabbitmq_http_client = { version = "0.18.0", features = ["core", "blocking"] }
```

### Async Client

```toml
rabbitmq_http_client = { version = "0.18.0", features = ["core", "async"] }
```

### Blocking Client with Tabled Support

```toml
rabbitmq_http_client = { version = "0.18.0", features = ["core", "blocking", "tabled"] }
```

### Async CLient with Tabled Support

```toml
rabbitmq_http_client = { version = "0.18.0", features = ["core", "async", "tabled"] }
```
