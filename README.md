...
```toml
rabbitmq_http_client = { version = "0.92.0", features = ["core", "async"] }
```

### Blocking Client

```toml
rabbitmq_http_client = { version = "0.92.0", features = ["core", "blocking"] }
```

### With Tabled Support

```toml
rabbitmq_http_client = { version = "0.92.0", features = ["core", "async", "tabled"] }
rabbitmq_http_client = { version = "0.92.0", features = ["core", "blocking", "tabled"] }
```
...
```toml
rabbitmq_http_client = { version = "0.92.0", features = ["core", "async", "zeroize"] }
```
...
```toml
rabbitmq_http_client = { version = "0.92.0", default-features = false, features = ["core", "async", "rustls"] }
```
