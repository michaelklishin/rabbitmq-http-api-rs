...
```toml
rabbitmq_http_client = { version = "0.81.0", features = ["core", "async"] }
```

### Blocking Client

```toml
rabbitmq_http_client = { version = "0.81.0", features = ["core", "blocking"] }
```

### With Tabled Support

```toml
rabbitmq_http_client = { version = "0.81.0", features = ["core", "async", "tabled"] }
rabbitmq_http_client = { version = "0.81.0", features = ["core", "blocking", "tabled"] }
```
