...
#[test]
fn test_build_rejects_ftp_scheme() {
    let result = ClientBuilder::new()
...
#[test]
fn test_build_rejects_file_scheme() {
    let result = ClientBuilder::new()
...
#[test]
fn test_build_rejects_schemeless_endpoint() {
    let result = ClientBuilder::new()
...
#[test]
fn test_build_rejects_data_scheme() {
    let result = ClientBuilder::new()
...
#[test]
fn test_build_rejects_javascript_scheme() {
    let result = ClientBuilder::new()
...
#[test]
fn test_error_message_includes_endpoint() {
    let result = ClientBuilder::new()
...
#[test]
fn test_with_redirect_policy_limited() {
    let result = ClientBuilder::new()
...
#[test]
fn test_redirect_policy_overrides_recommended_defaults() {
    let result = ClientBuilder::new()
...
#[test]
fn test_recommended_defaults_builds_successfully() {
...
#[test]
fn test_custom_client_ignores_redirect_policy() {
    let custom_client = reqwest::blocking::Client::new();
    let result = ClientBuilder::new()
        .with_redirect_policy(RedirectPolicy::none())
...
#[test]
fn test_custom_client_still_validates_endpoint_scheme() {
    let custom_client = reqwest::blocking::Client::new();
    let result = ClientBuilder::new()
        .with_endpoint("ftp://example.com/api")
        .with_client(custom_client)
...
#[test]
fn test_redirect_policy_preserved_across_with_endpoint() {
    let result = ClientBuilder::new()
        .with_redirect_policy(RedirectPolicy::none())
        .with_endpoint("http://localhost:15672/api")
        .build();
...
#[test]
fn test_redirect_policy_preserved_across_with_credentials() {
    let result = ClientBuilder::new()
        .with_redirect_policy(RedirectPolicy::none())
...
#[test]
fn test_all_builder_settings_combined() {
    let result = ClientBuilder::new()
        .with_endpoint("https://rabbitmq.example.com:15672/api")
...
#[test]
fn test_build_accepts_owned_string_endpoint() {
...
#[test]
fn test_build_rejects_owned_string_ftp_endpoint() {
...
#[test]
fn test_build_rejects_uppercase_http() {
    let result = ClientBuilder::new()
        .with_endpoint("HTTP://localhost:15672/api")
        .build();
    assert!(result.is_err());
...
#[test]
fn test_build_rejects_mixed_case_https() {
    let result = ClientBuilder::new()
