...
proptest! {
    ...
    fn prop_async_durable_client_named_classic_queue(
        ...
        rt.block_on(async {
            ...
            let declare_result = client.declare_queue(vhost, &params).await;
            prop_assert!(declare_result.is_ok(), "Failed to declare classic queue: {declare_result:?}");

            test_helpers::async_await_metric_emission(20).await;
    ...
    fn prop_async_durable_client_named_quorum_queue(
        ...
        rt.block_on(async {
            ...
            let list_result = client.list_queues_in(vhost).await;
    ...
    fn prop_async_stream_essential_ops(
        ...
        rt.block_on(async {
            ...
            let list_result = client.list_queues_with_details().await;
    ...
    fn prop_async_transient_autodelete_classic_queue(
        ...
        rt.block_on(async {
            ...
            let get_result = client.get_queue_info(vhost, &name).await;
    ...
    fn prop_async_list_queues_consistency(
        ...
        rt.block_on(async {
            ...
            let list_all_result = client.list_queues().await;
            prop_assert!(list_all_result.is_ok(), "Failed to list all queues: {list_all_result:?}");

            let list_vhost_result = client.list_queues_in(vhost).await;
