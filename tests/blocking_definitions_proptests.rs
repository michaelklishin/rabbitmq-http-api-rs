...
fn arb_vhost_name() -> impl Strategy<Value = String> {
    prop::string::string_regex(r"rust\.tests\.blocking\.proptest\.definitions\.vhosts\.[a-zA-Z0-9_-]{8,20}")
        .unwrap()
}

fn arb_username() -> impl Strategy<Value = String> {
    prop::string::string_regex(r"rust\.tests\.blocking\.proptest\.definitions\.users\.[a-zA-Z0-9_-]{8,20}")
        .unwrap()
}
...
fn arb_queue_name() -> impl Strategy<Value = String> {
    prop::string::string_regex(r"rust\.tests\.blocking\.proptest\.definitions\.queues\.[a-zA-Z0-9_-]{8,20}")
        .unwrap()
}

fn arb_exchange_name() -> impl Strategy<Value = String> {
    prop::string::string_regex(r"rust\.tests\.blocking\.proptest\.definitions\.exchanges\.[a-zA-Z0-9_-]{8,20}")
        .unwrap()
}

fn arb_policy_name() -> impl Strategy<Value = String> {
    prop::string::string_regex(r"rust\.tests\.blocking\.proptest\.definitions\.policies\.[a-zA-Z0-9_-]{8,20}")
        .unwrap()
}
...
proptest! {
    ...
    fn prop_blocking_export_import_cluster_definitions_roundtrip(
        ...
        test_helpers::await_metric_emission(100);
